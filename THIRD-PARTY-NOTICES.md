...
Losto bundles the open-source work listed below. Each component remains under
...
Self-hosted by `next/font` and therefore redistributed with the app. The SIL
Open Font License requires this notice and forbids selling the fonts on their own.

| Typeface | Authors | Licence |
| --- | --- | --- |
| [Plus Jakarta Sans](https://fonts.google.com/specimen/Plus+Jakarta+Sans) | Tokotype | SIL Open Font License 1.1 |
| [Bricolage Grotesque](https://fonts.google.com/specimen/Bricolage+Grotesque) | Mathieu Triay | SIL Open Font License 1.1 |
| [JetBrains Mono](https://fonts.google.com/specimen/JetBrains+Mono) | JetBrains | SIL Open Font License 1.1 |
...
- **@mixmark-io/domino** 2.2.0 - Felix Gnass <fgnass@gmail.com> - <https://github.com/mixmark-io/domino>
- **entities** 6.0.1 - Felix Boehm <me@feedic.com> - <git://github.com/fb55/entities>

### BSD-3-Clause (2)

- **highlight.js** 11.12.0 - Josh Goebel <hello@joshgoebel.com> - <https://highlightjs.org/>
- **source-map-js** 1.2.1 - Valentin 7rulnik Semirulnik <v7rulnik@gmail.com> - <https://github.com/7rulnik/source-map-js>

### CC-BY-4.0 (1)

- **caniuse-lite** 1.0.30001809 - Ben Briggs

### ISC (4)

- **@ungap/structured-clone** 1.3.3 - Andrea Giammarchi - <https://github.com/ungap/structured-clone#readme>
- **hast-util-from-dom** 5.0.1 - Keith McKnight <keith@mcknig.ht> (https://keith.mcknig.ht)
...
- **commander** 8.3.0 - TJ Holowaychuk <tj@vision-media.ca> - <https://github.com/tj/commander.js>
- **debug** 4.4.3 - Josh Junon (https://github.com/qix-) - <git://github.com/debug-js/debug>
- **decode-named-character-reference** 1.3.0 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
...
- **extend** 3.0.2 - Stefan Thomas <justmoon@members.fsf.org> (http://www.justmoon.net) - <https://github.com/justmoon/node-extend>
- **hast-util-from-html** 2.0.3 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
- **hast-util-from-html-isomorphic** 2.0.0 - Remco Haszing <remcohaszing@gmail.com>
- **hast-util-from-parse5** 8.0.3 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
- **hast-util-is-element** 3.0.0 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
- **hast-util-parse-selector** 4.0.0 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
- **hast-util-to-jsx-runtime** 2.3.6 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
- **hast-util-to-text** 4.0.2 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
- **hast-util-whitespace** 3.0.0 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
- **hastscript** 9.0.1 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
...
- **mdast-util-from-markdown** 2.0.3 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
...
- **mdast-util-math** 3.0.0 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
...
- **micromark-extension-math** 3.1.0 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
...
- **ms** 2.1.3
- **nanoid** 3.3.18 - Andrey Sitnik <andrey@sitnik.ru>
- **next** 16.3.2 - <https://nextjs.org>
...
- **rehype-highlight** 7.0.2 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
- **rehype-katex** 7.0.1 - Junyoung Choi <fluke8259@gmail.com> (https://rokt33r.github.io)
- **remark-gfm** 4.0.1 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
- **remark-math** 6.0.0 - Junyoung Choi <fluke8259@gmail.com> (https://rokt33r.github.io)
...
- **style-to-js** 1.1.21 - Mark <mark@remarkablemark.org> - <https://github.com/remarkablemark/style-to-js>
- **style-to-object** 1.0.14 - Mark <mark@remarkablemark.org> - <https://github.com/remarkablemark/style-to-object>
- **styled-jsx** 5.1.6
...
- **turndown** 7.2.4 - Dom Christie - <https://github.com/mixmark-io/turndown>
- **unified** 11.0.5 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com) - <https://unifiedjs.com>
- **unist-util-find-after** 5.0.0 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
...
- **unist-util-remove-position** 5.0.0 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
- **unist-util-stringify-position** 4.0.0 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
- **unist-util-visit** 5.1.0 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
...
- **vfile-location** 5.0.3 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
- **vfile-message** 4.0.3 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
- **web-namespaces** 2.0.1 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)
- **zwitch** 2.0.4 - Titus Wormer <tituswormer@gmail.com> (https://wooorm.com)

## Content saved by users

Conversations, articles, pictures and clips that a person saves with Losto are
**not** covered by these notices. That material belongs to whoever created it.
Losto stores it on the reader's own device for their personal use and keeps the
author, publication and original link attached to every saved copy.
